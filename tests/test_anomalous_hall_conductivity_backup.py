...
def test_fe_bcc(in_tmp_dir):
    ...
    #print(test_sigma_xy_def)
    #print(test_sigma_yz_def)
    #print(test_sigma_zx_def)
    ...
    #print(test_sigma_xy_wr_so)
    #print(test_sigma_yz_wr_so)
    #print(test_sigma_zx_wr_so)
    ...
    #print(test_sigma_xy_M_x)
    #print(test_sigma_yz_M_x)
    #print(test_sigma_zx_M_x)
    ...
    #print(test_sigma_xy_M_y)
    #print(test_sigma_yz_M_y)
    #print(test_sigma_zx_M_y)
    ...
    #print(test_sigma_xy_n6)
    #print(test_sigma_yz_n6)
    #print(test_sigma_zx_n6)
    ...
    #print(test_sigma_xy_bandocc2)
    #print(test_sigma_yz_bandocc2)
    #print(test_sigma_zx_bandocc2)
